...
essay is to educate, to increase the familiarity with PGA so that more people can make innovative, geometry 
intensive applications. The source code for the animations and the PGA library is in the 
