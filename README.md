...
essay is to educate, to increase the familiarity with PGA so more people can make innovative applications
of geometry. The source code for the animations and the PGA library is in the 
